...
public enum MessageEnum {
     ...
     */
    VALIDATION_ERROR_REQUIRED("*は必須項目です。"),
     ...
     */
    VALIDATION_ERROR_NAME("*は必須項目です。氏名の形式で入力してください。"),
     ...
     */
    VALIDATION_ERROR_NAME_KANA("*は必須項目です。フリガナの形式で入力してください。"),
     ...
     * ID00000は使用禁止
     */
    VALIDATION_ERROR_EMPLOYEE_ID("*は必須項目です。利用できるID 5桁を入力してください。"),
     ...
     * 生年月日は必須項目です。
     */
    VALIDATION_ERROR_BIRTH_DATE("*は必須項目です。項目範囲の生年月日を選択してください。"),
     ...
     * 入社年月は必須項目です。
     */
    VALIDATION_ERROR_JOIN_DATE("*は必須項目です。項目範囲の入社年月を選択してください。"),
     ...
     * エンジニア歴は必須項目です。
     */
    VALIDATION_ERROR_CAREER("*は必須項目です。項目範囲のエンジニア歴を選択してください。"),
