 ...
 * メッセージの一貫性を保ちつつ、多言語対応の基盤を提供します。
 * 
 * <p>
 * このクラスにより、システム全体で使用するメッセージを統一的に管理できるため、
 * メッセージの変更や国際化（i18n）対応が容易になります。フォーマット済みのメッセージを
 * 取得するためのメソッドも提供しており、動的な情報をメッセージに含めることができます。
 * </p>
 * 
 * <p>
